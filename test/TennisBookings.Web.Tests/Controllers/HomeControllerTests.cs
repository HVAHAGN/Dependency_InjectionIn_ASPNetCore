...
//        {
//            var mockWeatheForcaster = new Mock<IWeatherForecaster>();
//            mockWeatheForcaster.Setup(w => w.GetCurrentWeather()).Returns(new WeatherResult
//            {
//                WeatherCondition=WeatherCondition.Rain
//            });
//            var sut = new HomeController(mockWeatheForcaster.Object);
